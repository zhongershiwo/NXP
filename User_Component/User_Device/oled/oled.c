...
//void CCD0_Image_Display(void)
//{
//	uint8_t Data_transform[9] = {0,128,64,32,16,8,4,2,1};
//	uint8_t row_group,row_number,cross;
//	uint8_t data_temp;
//
//
//	for(cross=0;cross<128;cross++)
//	{
//		data_temp = CCD_IMG0[cross] / 4;
//		if ( data_temp == 0 || data_temp >48)
//		{
//			data_temp = 47;
//		}
//		row_group = 7 - (data_temp / 8);
//		row_number = (data_temp % 8);
//
//		OLED_Set_Pos(cross,row_group);
//		OLED_Write_Data(Data_transform[row_number]);
//
////		if (cross != 0) { Draw_edge(CCD_IMG1[cross],CCD_IMG1[cross-1],cross-1);}
//	}
//	OLED_Set_Pos(leftline0,0);
//	OLED_Write_Data(63);
//	OLED_Set_Pos(rightline0,0);
//	OLED_Write_Data(63);
//	OLED_Set_Pos((leftline0+rightline0)/2,0);
//	OLED_Write_Data(63);
//    Delay();
//  	OLED_Clear();
//}
//void CCD1_Image_Display(void)
//{
//	uint8_t Data_transform[9] = {0,128,64,32,16,8,4,2,1};
//	uint8_t row_group,row_number,cross;
//	uint8_t data_temp;
...
//	for(cross=0;cross<128;cross++)
//	{
//		data_temp = CCD_IMG1[cross] / 4;
//		if ( data_temp == 0 || data_temp >48) { continue; }
//		row_group = 7 - (data_temp / 8);
//		row_number = (data_temp % 8);
//
//		OLED_Set_Pos(cross,row_group);
...
////		if (cross != 0) { Draw_edge(CCD_IMG1[cross],CCD_IMG1[cross-1],cross-1);}
//	}
//	OLED_Set_Pos(leftline1,0);
//	OLED_Write_Data(63);
//	OLED_Set_Pos(rightline1,0);
//	OLED_Write_Data(63);
//	OLED_Set_Pos((leftline1+rightline1)/2,0);
//	OLED_Write_Data(63);
//    Delay();
//  	OLED_Clear();
//}
