...
**
**     Reference manual:    K10P144M100SF2V2RM Rev. 2, Jun 2012
**     Version:             rev. 1.9, 2013-10-29
**
**     Abstract:
**         This header file implements peripheral memory map for MK10D10
**         processor.
**
...
**     - rev. 1.2 (2012-03-26)
**         AXBS - control register for unsupported AXBS master removed.
 ...
 * @version 1.9
 * @date 2013-10-29
 * @brief Peripheral memory map for MK10D10
 *
 * This header file implements peripheral memory map for MK10D10 processor.
 */
...
#if !defined(MCU_MK10D10)  /* Check if memory map has not been already included */
#define MCU_MK10D10

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK10D10 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  INT_Reserved89               = 89,               /**< Reserved interrupt 89 */
  INT_Reserved90               = 90,               /**< Reserved interrupt 90 */
...
#define AXBS_MGPCR4_REG(base)                    This_symbol_has_been_deprecated
#define AXBS_MGPCR4                              This_symbol_has_been_deprecated
#define AXBS_MGPCR4_AULB_MASK                    This_symbol_has_been_deprecated
#define AXBS_MGPCR4_AULB_SHIFT                   This_symbol_has_been_deprecated
#define AXBS_MGPCR4_AULB(x)                      This_symbol_has_been_deprecated
